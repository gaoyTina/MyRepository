...
Page({
  ...
  fnsaveorder:function(){
    ...
    {
      wx.request({
        url: app.globalData.url+'/dcapi/saveorder',
        method: 'POST',
        data: {
  ...
  fnchangenum:function(id,typeid)
  {
    var that=this;
    wx.request({
      url: app.globalData.url+'/dcapi/changecarnum',
      method: 'POST',
      data: {
        id:id,
        typeid:typeid
  ...
  fndeleteitembyid:function(e){
    ...
    var id=e.currentTarget.dataset.id;
    wx.request({
      url: app.globalData.url+'/dcapi/deleteitembyid',
      method: 'POST',
      data: {
        id:id
      },
  ...
  fngetdata:function()
  {
    ...
    var currentuserid=wx.getStorageSync('currentuserid');
    wx.request({
      url: app.globalData.url+'/dcapi/getcarlist',
      method: 'POST',
      data: {
        userid :currentuserid
      },
